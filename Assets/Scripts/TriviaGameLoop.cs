...
public class TriviaGameLoop : MonoBehaviour {
	...
	private Question currentQuestion = new Question("What is your favourite color?", new string[]{"blue", "red", "yellow", "white", "black"}, 0);
	...
	void Start () {
		...
		questions [0] = new Question ("What is the capital of Spain?", new string[] {
			"Topeka",
			"Amsterdam",
			"Madrid",
			"London",
		...
		questions [1] = new Question ("Who was the second US president?", new string[] {
			"Thomas Jefferson",
			"John Adams",
			"Bill Clinton",
			"George Washington",
		...
		questions [2] = new Question ("What is the second planet in our solar system?", new string[] {
			"Mercury",
			"Earth",
			"Saturn",
			"Venus",
		...
		questions [3] = new Question ("What is the largest continent?", new string[] {
			"Africa",
			"North America",
			"Asia",
			"Europe",
		...
		questions [4] = new Question ("What US state has the highest population?", new string[] {
			"California",
			"Florida",
			"Texas",
			"New York",
		...
		questions [5] = new Question ("A Platypus is a ______?", new string[] {
			"Bird",
			"Reptile",
			"Insect",
			"Amphibian",
		...
		questions [6] = new Question ("What is the boiling temperature in fahrenheit?", new string[] {
			"100 degrees",
			"190 degrees",
			"300 degrees",
			"312 degrees",
		...
		questions [7] = new Question ("How many degrees are in a circle?", new string[] {
			"360",
			"180",
			"640",
			"16",
		...
		questions [8] = new Question ("What is a name for a group of crows?", new string[] {
			"A bloat",
			"A herd",
			"A pack",
			"A murder",
		...
		questions [9] = new Question ("Who created the painting starry night?", new string[] {
			"Pablo Picasso",
			"Vincent Van Gogh",
			"Andy Warhol",
			"Leonardo Da Vinci",
	...
	// Giving feedback for question answered
	...
	// Setting the results text to the appropriate text depending on how many questions were answered correctly
	void displayResults() {
